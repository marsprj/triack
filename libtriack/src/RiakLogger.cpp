...
namespace radi
{
	...
	//{
	//	//日志文件路径
	//	char szloggerPath[RADI_PATH_MAX];
	//	memset(szloggerPath, 0, RADI_PATH_MAX);
	//
	//	try
	//	{
	//		//配置文件路径
	//		char szConfigPath[RADI_PATH_MAX];
	//		memset(szConfigPath, 0, RADI_PATH_MAX);
	//	
	//		//当前工作路径
	//		char szcwd[RADI_PATH_MAX];
	//		memset(szcwd, 0, RADI_PATH_MAX);
	//	
	//		//日志路径
 //			char szlogDir[RADI_PATH_MAX];
	//// 		char szDir[RADI_PATH_MAX];//路径,以及配置文件路径
	//#ifdef _WIN32           
	//		char szDrv[_MAX_DRIVE];//驱动
	//		char szDir[_MAX_DIR];//路径,以及配置文件路径
	//	
	//		if(config_path==NULL)
	//		{
	//			::GetModuleFileName(NULL, szcwd, RADI_PATH_MAX);
